...
export enum PriceQueryActionTypes {
  ...
  FetchPriceInRangeQuery = 'priceQueryInRange.fetch',
...
export class FetchPriceQueryInRange implements Action {
  readonly type = PriceQueryActionTypes.FetchPriceInRangeQuery;
